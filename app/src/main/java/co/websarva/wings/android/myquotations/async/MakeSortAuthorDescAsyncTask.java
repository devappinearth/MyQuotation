...
public class MakeSortAuthorDescAsyncTask extends AsyncTask<Quotations,Void,Quotations> {

    private static final String TAG = "MakeSortAuthorDesAsyTas";
    ...
    public MakeSortAuthorDescAsyncTask(QuotationDao dao) { mQuotationDao = dao;}
    ...
    protected void onPostExecute(Quotations quotations) {
        ...
        if(quotations == null){
            ...
            //著者名昇順（author_order_by_DESC）で上書きする
