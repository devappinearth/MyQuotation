...
public class MakeSortQuotationAscAsyncTask extends AsyncTask<Quotations,Void,Quotations> {
    ...
    public MakeSortQuotationAscAsyncTask(QuotationDao dao) { mQuotationDao = dao;}
