...
public class MakeSortQuotationIdDescAsyncTask extends AsyncTask<Quotations,Void,Quotations> {
    ...
    public MakeSortQuotationIdDescAsyncTask(QuotationDao dao) { mQuotationDao = dao;}
